...
export const instamart = {
   ...
   *   Swiggy Money:  { addressId, paymentMethod: 'SwiggyPay' }
   *
   * Swiggy Money settles server-side — no bridgeUrl/upiIntentUrl to hand off
   * to, unlike UPI. It may still come back PENDING_PAYMENT briefly; poll
   * check_payment_status with a short budget, not the UPI long-poll window.
   *
